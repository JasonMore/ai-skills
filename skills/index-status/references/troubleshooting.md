...
**Solutions**:
- Run `grepika-index` to trigger incremental update
...
**Solutions**:
- Force full rebuild with `grepika-index`
...
- Ask this skill to check index status periodically
...
| "Index not found" | Never indexed | Run `grepika-index` |
